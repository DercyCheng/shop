...
func SendSms(ctx *gin.Context) {
	...
	request.QueryParams["TemplateCode"] = "SMS_257793008"               //阿里云的短信模板号 自己设置
	...
	//})
	global.RedisClient.Set(context.Background(), sendSmsForm.Mobile, smsCode, time.Duration(global.ServerConfig.RedisInfo.Expire)*time.Second)
