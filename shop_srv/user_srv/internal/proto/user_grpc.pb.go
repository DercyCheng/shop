...
const (
	User_GetUserList_FullMethodName     = "/v1user.User/GetUserList"
	User_GetUserByMobile_FullMethodName = "/v1user.User/GetUserByMobile"
	User_GetUserById_FullMethodName     = "/v1user.User/GetUserById"
	User_CreateUser_FullMethodName      = "/v1user.User/CreateUser"
	User_UpdateUser_FullMethodName      = "/v1user.User/UpdateUser"
	User_CheckPassWord_FullMethodName   = "/v1user.User/CheckPassWord"
)
