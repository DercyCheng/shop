...
const (
	Inventory_SetInv_FullMethodName    = "/v1inventoryproto.Inventory/SetInv"
	Inventory_InvDetail_FullMethodName = "/v1inventoryproto.Inventory/InvDetail"
	Inventory_Sell_FullMethodName      = "/v1inventoryproto.Inventory/Sell"
	Inventory_Reback_FullMethodName    = "/v1inventoryproto.Inventory/Reback"
)
...
var Inventory_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1inventoryproto.Inventory",
