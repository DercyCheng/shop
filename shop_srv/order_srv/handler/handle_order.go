...
func (o *OrderListener) ExecuteLocalTransaction(msg *primitive.Message) primitive.LocalTransactionState {
	...
	//发送延时消息
	p, err := rocketmq.NewProducer(producer.WithNameServer([]string{"192.168.206.135:9876"}))
	if err != nil {
		panic("生成producer失败")
	}
...
func (*OrderServer) CreateOrder(ctx context.Context, req *proto.OrderRequest) (*proto.OrderInfoResponse, error) {
	...
	*/
	...
	p, err := rocketmq.NewTransactionProducer(
		&orderListener,
		producer.WithNameServer([]string{"192.168.206.135:9876"}),
	)
	if err != nil {
...
func (*OrderServer) UpdateOrderStatus(ctx context.Context, req *proto.OrderStatus) (*emptypb.Empty, error) {
	...
	//因为中间没有更多的业务逻辑需要执行，这里直接使用update即可
