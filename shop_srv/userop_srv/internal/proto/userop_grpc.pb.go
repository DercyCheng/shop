...
const (
	UserOp_GetAddressList_FullMethodName   = "/v1userop.UserOp/GetAddressList"
	UserOp_CreateAddress_FullMethodName    = "/v1userop.UserOp/CreateAddress"
	UserOp_DeleteAddress_FullMethodName    = "/v1userop.UserOp/DeleteAddress"
	UserOp_UpdateAddress_FullMethodName    = "/v1userop.UserOp/UpdateAddress"
	UserOp_MessageList_FullMethodName      = "/v1userop.UserOp/MessageList"
	UserOp_CreateMessage_FullMethodName    = "/v1userop.UserOp/CreateMessage"
	UserOp_GetFavList_FullMethodName       = "/v1userop.UserOp/GetFavList"
	UserOp_AddUserFav_FullMethodName       = "/v1userop.UserOp/AddUserFav"
	UserOp_DeleteUserFav_FullMethodName    = "/v1userop.UserOp/DeleteUserFav"
	UserOp_GetUserFavDetail_FullMethodName = "/v1userop.UserOp/GetUserFavDetail"
)
...
func (c *userOpClient) GetAddressList(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*AddressListResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserOp_GetAddressList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) CreateAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*AddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserOp_CreateAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) DeleteAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, UserOp_DeleteAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) UpdateAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, UserOp_UpdateAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) MessageList(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageListResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserOp_MessageList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) CreateMessage(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserOp_CreateMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) GetFavList(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*UserFavListResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserOp_GetFavList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) AddUserFav(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, UserOp_AddUserFav_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) DeleteUserFav(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, UserOp_DeleteUserFav_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userOpClient) GetUserFavDetail(ctx context.Context, in *UserFavRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, UserOp_GetUserFavDetail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserOpServer) DeleteAddress(context.Context, *AddressRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAddress not implemented")
}
func (UnimplementedUserOpServer) UpdateAddress(context.Context, *AddressRequest) (*Empty, error) {
